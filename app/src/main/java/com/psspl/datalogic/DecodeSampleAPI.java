...
public class DecodeSampleAPI extends AppCompatActivity implements ReadListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decodesampleapi);
    ...
    private void setupView() {
        ...
        mScan.setOnTouchListener(new View.OnTouchListener() {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.decodeapi, menu);
        return true;
    }
